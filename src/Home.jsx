...
<div id="Home" className="h-[610px] px-5 xl:px-28 py-10 pt-[120px] bg-[url(./assets/image.jpg)] scroll-mt-20  bg-repeat-round flex flex-row ">
    <div id="Title" className="md:w-1/2 w-full  flex flex-col pr-7 gap-6">
        <h1 className="text-white text-3xl font-bold  "> <span className="text-blue-500" >Greetings!</span> <br/> Am Dev Macharia,a Software and Web Developer.</h1>
        <article className="text-slate-200 text-lg ">A deligent software and fullstack web developer knowledgable of developing technologies,which include but not limited to Javascript, ReactJs, Tailwind CSS, NodeJs,RestFull  API's, git, MongoGb, mySQL and Infrastructure as code technologies like Github,Docker.</article>

        <div className="flex gap-4"> 
            <button className="bg-blue-700 p-2 rounded md hover:bg-blue-500 hover:shadow-md text-white" >Services</button>
            <button className="bg-blue-700 p-2 rounded md hover:bg-blue-500 hover:shadow-md text-white "> Ackowledgement</button>
        </div>
        <div  className="lg:hidden flex flex-col gap-4 md:gap-0" ><h1 className="text-2xl h-[40px] font-bold text-blue-500 " >I do Create: <span className="text-white">{currentText}</span>  <span className="blinking-cursor">|</span> </h1>
