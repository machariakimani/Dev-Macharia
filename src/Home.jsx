...
<div id="Home" className="h-full px-5 xl:px-28 py-10 pt-[80px] bg-[url(./assets/image.jpg)] scroll-mt-20  bg-repeat-round flex flex-row ">
    <div id="Title" className="md:w-1/2 w-full  flex flex-col pr-7 gap-6">
        ...
        <article className="text-white sm:text-lg ">A deligent software and fullstack web developer knowledgable of modern developent tools ie,<br></br> <span className="text-blue-500 font-bold ">FrontEnd:</span>Javascript, TypeScript, ReactJs, Tailwind CSS,AngularJs. <br></br> <span className="text-blue-500 font-bold ">BackEnd:</span> NodeJs,Express Js, MongoGb, MySQL,PostGreSql and Infrastructure as code technologies like Github,Docker,Render.</article>
