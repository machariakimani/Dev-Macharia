...
<div id="Home" className="min-h-screen px-5 xl:px-28 py-10 pt-[80px] bg-[url(./assets/image.jpg)] scroll-mt-20  bg-repeat-round flex flex-row ">
    <div id="Title" className="md:w-1/2 w-full py-20 flex flex-col pr-7 gap-6">
        ...
        <div className="flex gap-4"> 
            ...
            <button className="bg-blue-700 p-2 flex rounded md hover:bg-blue-500 hover:shadow-md text-white "> 
               Blogs</button>
        </div>
        <div  className="lg:hidden flex flex-col gap-4 md:gap-0" ><h1 className="text-xl md:text-2xl h-[40px] font-bold text-blue-600 " >I do Create: <span className="text-white">{currentText}</span>  <span className="blinking-cursor">|</span> </h1>
